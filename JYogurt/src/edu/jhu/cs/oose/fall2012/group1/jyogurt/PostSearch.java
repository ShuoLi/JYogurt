...
/**
 * The search function class. Search for a sepecific post by keyword
 * 
 * @author Alan
 * 
 */
public class PostSearch extends ListActivity {
	...
	/**
	 * The behaviors when a list item is clicked
	 */
	...
	/**
	 * The function for getting the search result list
	 * 
	 * @param path
	 * @return
	 */
